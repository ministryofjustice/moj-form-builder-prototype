...
gulp.task('watch-sass', function () {
  return gulp.watch([config.paths.components + '/**', config.paths.assets + 'sass/**'], { cwd: './' }, gulp.task('sass'))
})

gulp.task('watch-assets', function () {
  return gulp.watch([config.paths.components + '/**', config.paths.assets + 'images/**',
